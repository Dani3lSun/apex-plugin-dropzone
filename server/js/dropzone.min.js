var $jscomp={scope:{}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(e,d,a){if(a.get||a.set)throw new TypeError("ES3 does not support getters and setters.");e!=Array.prototype&&e!=Object.prototype&&(e[d]=a.value)};$jscomp.getGlobal=function(e){return"undefined"!=typeof window&&window===e?e:"undefined"!=typeof global&&null!=global?global:e};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(e,d,a,b){if(d){a=$jscomp.global;e=e.split(".");for(b=0;b<e.length-1;b++){var c=e[b];c in a||(a[c]={});a=a[c]}e=e[e.length-1];b=a[e];d=d(b);d!=b&&null!=d&&$jscomp.defineProperty(a,e,{configurable:!0,writable:!0,value:d})}};$jscomp.polyfill("Object.setPrototypeOf",function(e){return e?e:"object"!=typeof"".__proto__?null:function(d,a){d.__proto__=a;if(d.__proto__!==a)throw new TypeError(d+" is not extensible");return d}},"es6","es5");
...
b?b-1:0),d=1;d<b;d++)c[d-1]=arguments[d];for(b=0;!(b>=c.length);){var d=c[b++],g;for(g in d)a[g]=d[g]}return a}}]);_createClass(d,[{key:"getAcceptedFiles",value:function(){return this.files.filter(function(a){return a.accepted}).map(function(a){return a})}},{key:"getRejectedFiles",value:function(){return this.files.filter(function(a){return!a.accepted}).map(function(a){return a})}},{key:"getFilesWithStatus",value:function(a){return this.files.filter(function(b){return b.status===a}).map(function(a){return a})}},
...
"0";document.querySelector(a.options.hiddenInputContainer).appendChild(a.hiddenFileInput);return a.hiddenFileInput.addEventListener("change",function(){var b=a.hiddenFileInput.files;if(b.length)for(var c=0;;){var d;if(c>=b.length)break;d=b[c++];a.addFile(d)}a.emit("addedfiles",b);return h()})}();this.URL=null!==window.URL?window.URL:window.webkitURL;for(var b=this.events,c=0;!(c>=b.length);){var f=b[c++];this.on(f,this.options[f])}this.on("uploadprogress",function(){return a.updateTotalUploadProgress()});
...
{key:"enable",value:function(){this.clickableElements.forEach(function(a){return a.classList.add("dz-clickable")});return this.setupEventListeners()}},{key:"filesize",value:function(a){var b=0,c="b";if(0<a){for(var d=["tb","gb","mb","kb","b"],g=0;g<d.length;g++){var e=d[g];if(a>=Math.pow(this.options.filesizeBase,4-g)/10){b=a/Math.pow(this.options.filesizeBase,4-g);c=e;break}}b=Math.round(10*b)/10}return"<strong>"+b+"</strong> "+this.options.dictFileSizeUnits[c]}},{key:"_updateMaxFilesReachedClass",
...
function(a){return EXIF.getData(g,function(){return a(EXIF.getTag(this,"Orientation"))})});return h(function(e){a.width=g.width;a.height=g.height;var h=f.options.resize.call(f,a,b,c,d),l=document.createElement("canvas"),m=l.getContext("2d");l.width=h.trgWidth;l.height=h.trgHeight;4<e&&(l.width=h.trgHeight,l.height=h.trgWidth);switch(e){case 2:m.translate(l.width,0);m.scale(-1,1);break;case 3:m.translate(l.width,l.height);m.rotate(Math.PI);break;case 4:m.translate(0,l.height);m.scale(1,-1);break;case 5:m.rotate(.5*
Math.PI);m.scale(1,-1);break;case 6:m.rotate(.5*Math.PI);m.translate(0,-l.height);break;case 7:m.rotate(.5*Math.PI);m.translate(l.width,-l.height);m.scale(-1,1);break;case 8:m.rotate(-.5*Math.PI),m.translate(-l.width,0)}drawImageIOSFix(m,g,null!=h.srcX?h.srcX:0,null!=h.srcY?h.srcY:0,h.srcWidth,h.srcHeight,null!=h.trgX?h.trgX:0,null!=h.trgY?h.trgY:0,h.trgWidth,h.trgHeight);e=l.toDataURL("image/png");if(null!=k)return k(e,l)})};null!=k&&(g.onerror=k);return g.src=a.dataURL}},{key:"processQueue",value:function(){var a=
...
a[0],e=c[0],k=0;f.upload.chunks=[];var h=function(){for(var c=0;void 0!==f.upload.chunks[c];)c++;if(!(c>=f.upload.totalChunkCount)){k++;var g=c*b.options.chunkSize,h=Math.min(g+b.options.chunkSize,f.size),g={name:b._getParamName(0),data:e.webkitSlice?e.webkitSlice(g,h):e.slice(g,h),filename:f.upload.filename,chunkIndex:c};f.upload.chunks[c]={file:f,index:c,dataBlock:g,status:d.UPLOADING,progress:0,retries:0};b._uploadData(a,[g])}};f.upload.finishedChunkUpload=function(c){var e=!0;c.status=d.SUCCESS;
c.dataBlock=null;for(c=0;c<f.upload.totalChunkCount;c++){if(void 0===f.upload.chunks[c])return h();f.upload.chunks[c].status!==d.SUCCESS&&(e=!1)}e&&b.options.chunksUploaded(f,function(){b._finished(a,"",null)})};if(b.options.parallelChunkUploads)for(c=0;c<f.upload.totalChunkCount;c++)h();else h()}else{for(var l=[],m=0;m<a.length;m++)l[m]={name:b._getParamName(m),data:c[m],filename:a[m].upload.filename};b._uploadData(a,l)}})}},{key:"_getChunk",value:function(a,b){for(var c=0;c<a.upload.totalChunkCount;c++)if(void 0!==
a.upload.chunks[c]&&a.upload.chunks[c].xhr===b)return a.upload.chunks[c]}},{key:"_uploadData",value:function(a,b){for(var c=this,f=new XMLHttpRequest,e=0;!(e>=a.length);)a[e++].xhr=f;a[0].upload.chunked&&(a[0].upload.chunks[b[0].chunkIndex].xhr=f);var e=this.resolveOption(this.options.method,a),k=this.resolveOption(this.options.url,a);f.open(e,k,!0);f.timeout=this.resolveOption(this.options.timeout,a);f.withCredentials=!!this.options.withCredentials;f.onload=function(b){c._finishedUploading(a,f,b)};
f.onerror=function(){c._handleUploadError(a,f)};(null!=f.upload?f.upload:f).onprogress=function(b){return c._updateFilesUploadProgress(a,f,b)};e={Accept:"application/json","Cache-Control":"no-cache","X-Requested-With":"XMLHttpRequest"};this.options.headers&&d.extend(e,this.options.headers);for(var h in e)(k=e[h])&&f.setRequestHeader(h,k);h=new FormData;if(this.options.params){e=this.options.params;"function"===typeof e&&(e=e.call(this,a,f,a[0].upload.chunked?this._getChunk(a[0],f):null));for(var l in e)h.append(l,
e[l])}for(l=0;!(l>=a.length);)e=a[l++],this.emit("sending",e,f,h);this.options.uploadMultiple&&this.emit("sendingmultiple",a,f,h);this._addFormElementData(h);for(l=0;l<b.length;l++)e=b[l],h.append(e.name,e.data,e.filename);this.submitRequest(f,h,a)}},{key:"_transformFiles",value:function(a,b){for(var c=this,d=[],e=0,k=function(f){c.options.transformFile.call(c,a[f],function(c){d[f]=c;++e===a.length&&b(d)})},h=0;h<a.length;h++)k(h)}},{key:"_addFormElementData",value:function(a){if("FORM"===this.element.tagName)for(var b=
...
a[e++],b.upload.progress=d,b.upload.total=c.total,b.upload.bytesSent=c.loaded;for(d=0;!(d>=a.length);)c=a[d++],this.emit("uploadprogress",c,c.upload.progress,c.upload.bytesSent)}else{c=!0;d=100;for(e=0;!(e>=a.length);){b=a[e++];if(100!==b.upload.progress||b.upload.bytesSent!==b.upload.total)c=!1;b.upload.progress=d;b.upload.bytesSent=b.upload.total}if(!c)for(c=0;!(c>=a.length);)e=a[c++],this.emit("uploadprogress",e,d,e.upload.bytesSent)}}},{key:"_finishedUploading",value:function(a,b,c){var e=void 0;
if(a[0].status!==d.CANCELED&&4===b.readyState){if("arraybuffer"!==b.responseType&&"blob"!==b.responseType&&(e=b.responseText,b.getResponseHeader("content-type")&&~b.getResponseHeader("content-type").indexOf("application/json")))try{e=JSON.parse(e)}catch(g){c=g,e="Invalid JSON response from server."}this._updateFilesUploadProgress(a);200<=b.status&&300>b.status?a[0].upload.chunked?a[0].upload.finishedChunkUpload(this._getChunk(a[0],b)):this._finished(a,e,c):this._handleUploadError(a,b,e)}}},{key:"_handleUploadError",
value:function(a,b,c){if(a[0].status!==d.CANCELED){if(a[0].upload.chunked&&this.options.retryChunks){var e=this._getChunk(a[0],b);if(e.retries++<this.options.retryChunksLimit){this._uploadData(a,[e.dataBlock]);return}console.warn("Retried this chunk too often. Giving up.")}for(e=0;!(e>=a.length);)e++,this._errorProcessing(a,c||this.options.dictResponseError.replace("{{statusCode}}",b.status),b)}}},{key:"submitRequest",value:function(a,b,c){a.send(b)}},{key:"_finished",value:function(a,b,c){for(var e=
0;!(e>=a.length);){var g=a[e++];g.status=d.SUCCESS;this.emit("success",g,b,c);this.emit("complete",g)}this.options.uploadMultiple&&(this.emit("successmultiple",a,b,c),this.emit("completemultiple",a));if(this.options.autoProcessQueue)return this.processQueue()}},{key:"_errorProcessing",value:function(a,b,c){for(var e=0;!(e>=a.length);){var g=a[e++];g.status=d.ERROR;this.emit("error",g,b,c);this.emit("complete",g)}this.options.uploadMultiple&&(this.emit("errormultiple",a,b,c),this.emit("completemultiple",
a));if(this.options.autoProcessQueue)return this.processQueue()}}],[{key:"uuidv4",value:function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"===a?b:b&3|8).toString(16)})}}]);return d}(Emitter);Dropzone.initClass();Dropzone.version="5.2.0";Dropzone.options={};Dropzone.optionsForElement=function(e){if(e.getAttribute("id"))return Dropzone.options[camelize(e.getAttribute("id"))]};Dropzone.instances=[];
Dropzone.forElement=function(e){"string"===typeof e&&(e=document.querySelector(e));if(null==(null!=e?e.dropzone:void 0))throw Error("No Dropzone found for given element. This is probably because you're trying to access it before Dropzone had the time to initialize. Use the `init` option to setup any additional observers on your Dropzone.");return e.dropzone};Dropzone.autoDiscover=!1;
Dropzone.discover=function(){var e=void 0;if(document.querySelectorAll)e=document.querySelectorAll(".dropzone");else{var e=[],d=function(a){for(var b=[],c=0;!(c>=a.length);){var d=a[c++];/(^| )dropzone($| )/.test(d.className)?b.push(e.push(d)):b.push(void 0)}return b};d(document.getElementsByTagName("div"));d(document.getElementsByTagName("form"))}return function(){for(var a=[],b=e,c=0;!(c>=b.length);){var d=b[c++];!1!==Dropzone.optionsForElement(d)?a.push(new Dropzone(d)):a.push(void 0)}return a}()};
...
return b=b.concat(c)}},{key:"slice2Segments",value:function(d){for(var a=0,b=[];;){var c;if(255===d[a]&218===d[a+1])break;255===d[a]&216===d[a+1]?a+=2:(c=256*d[a+2]+d[a+3],c=a+c+2,a=d.slice(a,c),b.push(a),a=c);if(a>d.length)break}return b}},{key:"decode64",value:function(d){var a,b,c,e,g,k=0,h=[];/[^A-Za-z0-9\+\/\=]/g.exec(d)&&console.warn("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding.");for(d=d.replace(/[^A-Za-z0-9\+\/\=]/g,
"");a=this.KEY_STR.indexOf(d.charAt(k++)),b=this.KEY_STR.indexOf(d.charAt(k++)),e=this.KEY_STR.indexOf(d.charAt(k++)),g=this.KEY_STR.indexOf(d.charAt(k++)),a=a<<2|b>>4,b=(b&15)<<4|e>>2,c=(e&3)<<6|g,h.push(a),64!==e&&h.push(b),64!==g&&h.push(c),k<d.length;);return h}}]);return e}();ExifRestore.initClass();
var contentLoaded=function(e,d){var a=!1,b=!0,c=e.document,f=c.documentElement,g=c.addEventListener?"addEventListener":"attachEvent",k=c.addEventListener?"removeEventListener":"detachEvent",h=c.addEventListener?"":"on",l=function p(b){if("readystatechange"!==b.type||"complete"===c.readyState)if(("load"===b.type?e:c)[k](h+b.type,p,!1),!a&&(a=!0))return d.call(e,b.type||b)},m=function n(){try{f.doScroll("left")}catch(q){setTimeout(n,50);return}return l("poll")};if("complete"!==c.readyState){if(c.createEventObject&&
f.doScroll){try{b=!e.frameElement}catch(n){}b&&m()}c[g](h+"DOMContentLoaded",l,!1);c[g](h+"readystatechange",l,!1);return e[g](h+"load",l,!1)}};Dropzone._autoDiscoverFunction=function(){if(Dropzone.autoDiscover)return Dropzone.discover()};contentLoaded(window,Dropzone._autoDiscoverFunction);function __guard__(e,d){return"undefined"!==typeof e&&null!==e?d(e):void 0}function __guardMethod__(e,d,a){if("undefined"!==typeof e&&null!==e&&"function"===typeof e[d])return a(e,d)};
